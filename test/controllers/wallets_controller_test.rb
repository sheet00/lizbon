...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { currency_type: @wallet.currency_type, money: @wallet.money } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { currency_type: @wallet.currency_type, money: @wallet.money } }
